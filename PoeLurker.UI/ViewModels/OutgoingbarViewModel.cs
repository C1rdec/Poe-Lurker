...
namespace PoeLurker.UI.ViewModels
{
    ...
    public class OutgoingbarViewModel : PoeOverlayBase
    {
        ...
        protected override void SetWindowPosition(PoeWindowInformation windowInformation)
        {
            ...
            Execute.OnUIThread(() =>
            {
                this.View.Height = this.ApplyAbsoluteScalingY(height < 0 ? 1 : height);
                this.View.Width = this.ApplyAbsoluteScalingX(width);
        ...
        private void SetActiveOffer(OutgoingOfferViewModel offer)
        {
            ...
            this._eventAggregator.PublishOnUIThreadAsync(new LifeBulbMessage()
            {
