    ...
    public class BuildViewModel : PoeOverlayBase
    {
        ...
        public bool GroupBySkill
        {
            ...
            set
            {
                ...
                this._eventAggregator.PublishOnUIThreadAsync(new SkillMessage());
            }
        }
            ...
            try
            {
                ...
                if (await this.Initialize(text, true))
                {
                    ...
                    if (selectedSKill != null)
                    {
                        ...
                        await this._eventAggregator.PublishOnUIThreadAsync(new SkillMessage() { Clear = true, Skill = selectedSKill.Skill });
                    }
                }
            }
            catch
        ...
        public void ClearBuild()
        {
            ...
            this._eventAggregator.PublishOnUIThreadAsync(new SkillMessage() { Clear = true });
        }
        ...
        public void NewBuild()
        {
            ...
            this._eventAggregator.PublishOnUIThreadAsync(this._settings);
        }
        ...
        protected override void SetWindowPosition(PoeWindowInformation windowInformation)
        {
            ...
            Execute.OnUIThread(() =>
            {
                this.View.Height = this.ApplyAbsoluteScalingY(500);
                this.View.Width = this.ApplyAbsoluteScalingX(350);
        ...
        private void SelectItems(bool raiseEvent = false)
        {
            ...
            foreach (var index in settings.SkillsSelected.ToArray())
            {
                ...
                if (selectedSKill != null)
                {
                    ...
                    if (raiseEvent)
                    {
                        this._eventAggregator.PublishOnUIThreadAsync(new SkillMessage() { Skill = selectedSKill.Skill });
                    }
                }
            }
            ...
            foreach (var index in settings.ItemsSelected.ToArray())
            {
                ...
                if (selectedItem != null)
                {
                    ...
                    if (raiseEvent)
                    {
                        this._eventAggregator.PublishOnUIThreadAsync(new ItemMessage() { Item = selectedItem.Item });
                    }
                }
            }
        }
        ...
        private void SetTimelineSettings(bool enabled)
        {
            ...
            this._eventAggregator.PublishOnUIThreadAsync(new SkillTimelineMessage() { IsVisible = enabled });
            foreach (var skillViewModel in this.Skills.Where(s => s.Selected))
            {
                this._eventAggregator.PublishOnUIThreadAsync(new SkillMessage() { Skill = skillViewModel.Skill });
            }
        }
