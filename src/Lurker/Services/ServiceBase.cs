...
namespace Lurker.Services
{
    ...
    public abstract class ServiceBase
    {
        ...
        /// </summary>
        protected string FolderPath => System.IO.Path.Combine(this.AppDataFolderPath, this.FolderName);

        /// <summary>
        /// Gets the settings file path.
        /// </summary>
        protected string FilePath => System.IO.Path.Combine(this.FolderPath, this.FileName);
