//-----------------------------------------------------------------------
// <copyright file="MouseHookService.cs" company="Wohs">
...
namespace Lurker
{
    ...
    public class MouseHookService : IDisposable
    {
        ...
        /// </summary>
        public event EventHandler<MouseMessageReceivedEventArgs> MouseLeftButtonUp;
        ...
        public MouseHookService(Process process)
        {
        ...
        {
            var eventArgs = new MouseMessageReceivedEventArgs
            {
